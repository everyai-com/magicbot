# Computer use & browser use in MagicBot

Decision doc, 2026-08-12. How bots in MagicBot get local computer use and
...
1. **Spawn from the Electron main process, never from the server/gateway
   ...
   Spawned from Electron main → the grant is MagicBot's, users see ONE
   prompt named MagicBot, and the bundled driver inherits it. Spawned from
...
- Ship the binary at `MagicBot.app/Contents/Resources/cua-driver`,
