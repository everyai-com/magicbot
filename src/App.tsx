  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <button
        ...
        className="absolute left-2 top-2 z-30 flex size-10 touch-manipulation items-center justify-center rounded-lg text-ink-secondary transition-colors hover:bg-raised hover:text-ink md:hidden"
      >
        <Menu size={18} />
      </button>
      {drawerOpen && (
...
export default function App() {
  // Hosted accounts already collected an identity during sign-up. Ask the
  // local-first desktop/browser build for its onboarding profile only when
  // the authenticated web endpoint is absent.
