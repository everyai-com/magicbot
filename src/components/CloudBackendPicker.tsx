    ...
    <div className="mt-3 rounded-lg bg-inset p-3">
      ...
      <div className="mt-0.5 text-[11.5px] text-ink-secondary">
        {selected === "vps"
          ...
          : "Cloudflare Computer gives this bot a persistent workspace and a private Linux runtime. Files survive container restarts; shell, code, and network access run in the cloud."}
      </div>
      <div className="mt-2 flex overflow-hidden rounded-lg border border-hairline/40">
        {(["cloudflare", "vps"] as const).map((backend, i) => {
          ...
          return (
            ...
            >
              {backend === "vps" ? "Self-hosted VPS" : "Cloudflare Computer"}
            </button>
          );
        })}
      </div>
