...
<sub>A fork of <a href="https://github.com/milind-soni/OpenMausBot">OpenMausBot</a> by Milind Soni, under the Apache-2.0 license.</sub>

**Your own team of AI bots, in a chat app.**

Every bot in the sidebar is a real agent — Claude, Codex, Pi, Cursor, OpenCode or an ACP engine running
locally under the hood — with its own personality, its own model, its own cloud computer, and its own
connected apps. Talk to them like contacts. Watch them work. Approve what matters.
...
![Agents](https://img.shields.io/badge/agents-Claude%20·%20Codex%20·%20Pi%20·%20Cursor%20·%20OpenCode-d97757)
