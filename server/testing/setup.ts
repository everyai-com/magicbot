...
// DATA_DIR (~/.magicbots) never touches the real one. os.homedir()
...
const home = mkdtempSync(join(tmpdir(), "mb-test-home-"));
process.env.HOME = home;
process.env.USERPROFILE = home;
// MB_DATA_DIR is an intentional production override, but tests must never
...
process.env.MB_COMPANION_DIR = join(home, ".magicbots-companion");
