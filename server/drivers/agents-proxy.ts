...
const TOOLS = [
  {
    name: "list_bots",
    description:
      "List the other bots (agents) in your MagicBot section you can message, with their model and whether they're busy. Call this before ask_bot to discover who's available.",
