...
const resources = process.env.MB_CUA_RESOURCES ?? join(root, "dist-native", hostArch);
process.env.MAGICBOTS_CUA_SDK_LIBRARY = join(resources, "cua-sdk/native/libcua_driver_sdk.dylib");
...
const host = new EmbeddedCuaDriverHost(binary, "com.magicbots.app");
let proxy;
...
try {
  ...
  await rpc("initialize", {
    ...
    capabilities: {},
    clientInfo: { name: "magicbots-package-smoke", version: "1" },
  });
