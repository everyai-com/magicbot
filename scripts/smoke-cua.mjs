...
process.env.MAGICBOT_CUA_SDK_LIBRARY = join(resources, "cua-sdk/native/libcua_driver_sdk.dylib");
...
const host = new EmbeddedCuaDriverHost(binary, "com.magicbot.app");
let proxy;
...
try {
  ...
  proxy = spawn(connection.mcp.command, connection.mcp.args, {
    env: {
      ...
      CUA_DRIVER_HOST_BUNDLE_ID: "com.magicbot.app",
  ...
  await rpc("initialize", {
    ...
    capabilities: {},
    clientInfo: { name: "magicbot-package-smoke", version: "1" },
  });
