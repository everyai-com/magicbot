...
function registryComponent(pkg, cargoLockPackages) {
  ...
  return {
    ...
    properties: [
      { name: "magicbots:cargo:package-id", value: pkg.id },
      { name: "magicbots:cargo:crate-sha256", value: locked.checksum },
    ],
  };
}
...
function interComponent() {
  return {
    ...
    properties: [
      {
        name: "magicbots:font:name-table-version",
        value: "Version 4.001;git-66647c0bb",
      },
      { name: "magicbots:font:embedded-sha256", value: INTER_FONT_SHA256 },
    ],
  };
}
...
<head>
  ...
  <title>MagicBots — Cua Driver third-party licenses</title>
...
const bom = {
  ...
  metadata: {
    component: {
      ...
      properties: [
        { name: "magicbots:archive:sha256", value: ARCHIVE_SHA256 },
        { name: "magicbots:cargo-lock:sha256", value: CARGO_LOCK_SHA256 },
        { name: "magicbots:target", value: "x86_64-unknown-linux-gnu" },
        { name: "magicbots:feature", value: "cua-driver/portal-input" },
        {
          name: "magicbots:registry-component-count",
          value: String(EXPECTED_REGISTRY_UNION_COUNT),
        },
        {
          name: "magicbots:trycua-component-count",
          value: String(TRYCUA_COMPONENTS.length),
        },
        {
          name: "magicbots:file:cua-driver:sha256",
          value:
            "ed5844fadf07b9b72c4a3b3802e1c47233c166d66d6198608d5991f807aab4ac",
        },
        {
          name: "magicbots:file:cua-cursor-theme:sha256",
          value:
...
MagicBots redistributes two executables from the official Cua Driver ${RELEASE_VERSION} Linux x64 release: \`cua-driver\` and \`cua-cursor-theme\`.
...
The complete MPL-2.0 text and package copyright notices appear in \`THIRD_PARTY_LICENSES.html\`. These files remain under their original licenses; MagicBots's and Cua's MIT licenses do not replace them.
