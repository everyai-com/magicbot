...
// ~/.magicbots would be reaching into somebody else's data layout — the
...
/** MB_COMPANION_DIR isolates a test rig from a real paired fleet. */
export const DATA_DIR = process.env.MB_COMPANION_DIR ?? join(homedir(), ".magicbots-companion");
