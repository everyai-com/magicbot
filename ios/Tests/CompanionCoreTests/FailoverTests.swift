...
final class FailoverTests: XCTestCase {
    ...
    func testWalksTheCandidatesInOrderAndWraps() {
        var rotation = CandidateRotation(hosts: ["mac.tail1234.ts.net", "192.168.1.42", "magicbot-aa.local"])
        XCTAssertEqual(rotation.current, "mac.tail1234.ts.net")
        XCTAssertEqual(rotation.advance(), "192.168.1.42")
        XCTAssertEqual(rotation.advance(), "magicbot-aa.local")
    ...
    func testPromotesTheWorkingCandidateToTheFront() {
        ...
        XCTAssertEqual(rotation.promoted(), ["192.168.1.42", "mac.tail1234.ts.net", "magicbot-aa.local"])
    }
    ...
    func testOrderedHostsLeadsWithTheStoredHostAndDeduplicates() {
        let connection = Connection(
            ...
            host: "192.168.1.42",
            port: 8810,
            hosts: ["mac.tail1234.ts.net", "192.168.1.42", "magicbot-aa.local"]
        )
        XCTAssertEqual(connection.orderedHosts, ["192.168.1.42", "mac.tail1234.ts.net", "magicbot-aa.local"])
    }
    ...
    func testPromoteReordersAndKeepsEveryCandidate() {
        ...
        XCTAssertEqual(connection.hosts, ["192.168.1.42", "mac.tail1234.ts.net", "magicbot-aa.local"])
