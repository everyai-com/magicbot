    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("Approvals and finished work appear while MagicBotsMobile is connected, including frames replayed after a short background pause. Closed-app push needs the separate APNs relay release.")
            }
            ...
            Section {
                ...
                Text("Removes the pairing from this phone only. To stop it reaching the computer at all, remove the device in MagicBots → Settings → Companion.")
            }
