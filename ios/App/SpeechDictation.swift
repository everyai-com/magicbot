...
final class SpeechDictation: ObservableObject {
    ...
    static let speechDeniedMessage =
        "Dictation needs Speech Recognition access. Enable it in Settings → MagicBotsMobile."
    static let micDeniedMessage =
        "Dictation needs Microphone access. Enable it in Settings → MagicBotsMobile."
}
