...
extension MascotState {
    ...
    private static let legacy: [String: MascotState] = [
    ...
    static func normalize(_ value: String?) -> MascotState? {
        guard let value, !value.isEmpty else { return nil }
        return MascotState(rawValue: value) ?? legacy[value]
    }

    static func forBot(_ bot: Bot, last: Message?) -> MascotState {
    ...
    static func forChat(_ chat: Chat, in state: CompanionState) -> MascotState {
        switch chat {
