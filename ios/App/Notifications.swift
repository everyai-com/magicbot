...
final class NotificationCoordinator: NSObject, UNUserNotificationCenterDelegate {
    ...
    func deliver(_ notification: NotificationFrame, sequence: Int?) {
        ...
        content.categoryIdentifier = notification.isBlocking ? "MAGICBOTS_APPROVAL" : "MAGICBOTS_UPDATE"
        ...
        let identifier = "magicbots.\(notification.threadId).\(sequence.map(String.init) ?? notification.title)"
