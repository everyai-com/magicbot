...
2. Register the bundle ID `com.magicbot.companion` (or change it in `project.yml` before the first upload).
3. Create the matching app in App Store Connect with the name **MagicBot Mobile**, primary category **Productivity**, and a unique SKU.
