...
2. Register the bundle ID `com.magicbots.companion` (or change it in `project.yml` before the first upload).
3. Create the matching app in App Store Connect with the name **MagicBots Mobile**, primary category **Productivity**, and a unique SKU.
...
- Support URL: `https://github.com/everyai-com/magicbot/issues`
