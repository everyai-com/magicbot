...
MagicBotsMobile is a companion for the MagicBots desktop application and does not use a developer-hosted login.

To review the app:

1. Install and start MagicBots on a Mac, Windows, or Linux computer.
