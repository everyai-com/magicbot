---
title: iOS companion
description: Pair an iPhone directly with the MagicBots instance running on your computer.
icon: Smartphone
---
...
There is no hosted MagicBots relay. Bonjour does not cross Tailscale, so remote connections use manual address entry.
