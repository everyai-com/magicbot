---
title: iOS companion
description: Pair an iPhone directly with the MagicBot instance running on your computer.
icon: Smartphone
---
...
There is no hosted MagicBot relay. Bonjour does not cross Tailscale, so remote connections use manual address entry.
