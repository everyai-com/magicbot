...
MagicBot welcomes focused fixes and features. Read the repository's [CONTRIBUTING.md](https://github.com/everyai-com/magicbot/blob/main/CONTRIBUTING.md) before opening a pull request.
