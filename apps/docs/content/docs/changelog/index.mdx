---
title: Changelog
description: Highlights from recent MagicBot desktop releases.
icon: Clock
---
...
- Existing OpenCode logins and anonymous free models now work without duplicate setup in MagicBot.

[Full 0.1.32 release notes](https://github.com/everyai-com/magicbot/releases/tag/v0.1.32)
...
[Full 0.1.29 release notes](https://github.com/everyai-com/magicbot/releases/tag/v0.1.29)
...
[Full 0.1.27 release notes](https://github.com/everyai-com/magicbot/releases/tag/v0.1.27)
...
[Full 0.1.25 release notes](https://github.com/everyai-com/magicbot/releases/tag/v0.1.25)
...
[Full 0.1.24 release notes](https://github.com/everyai-com/magicbot/releases/tag/v0.1.24)
...
[Full 0.1.23 release notes](https://github.com/everyai-com/magicbot/releases/tag/v0.1.23)
...
[Full 0.1.22 release notes](https://github.com/everyai-com/magicbot/releases/tag/v0.1.22)

<Callout type="info" title="Every release remains available">
  Browse checksums, installers, and older notes in the [MagicBot releases repository](https://github.com/everyai-com/magicbot/releases).
</Callout>
