---
title: Self-hosting MagicBots
description: Run the harness and desktop app on infrastructure you control.
icon: Server
---

MagicBots is local-first by default: the harness listens on loopback, agent CLIs run on your machine, and application state lives under `~/.magicbots`.

## Typical self-hosted setup

1. Run MagicBots on your personal macOS, Windows, or Ubuntu computer.
...
Self-hosting MagicBots does not self-host every optional provider:
