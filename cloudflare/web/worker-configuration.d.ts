/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/web/wrangler.jsonc cloudflare/web/worker-configuration.d.ts` (hash: 4b5f525df4865df076e8dab227dc4424)
