# MagicBots connected-apps broker
...
1. `pnpm broker:types`
2. `pnpm exec wrangler d1 migrations apply magicbot-composio --remote --config cloudflare/composio-broker/wrangler.jsonc`
...
`MB_COMPOSIO_BROKER_URL` in their packaged build. Running only the local
